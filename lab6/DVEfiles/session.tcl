...
# DVE full session
# Saved on Tue Nov 14 15:44:46 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{61 87} {1364 706}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 378} {child_wave_right 920} {child_wave_colname 187} {child_wave_colvalue 187} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 161 383
gui_list_add_group -id ${Wave.1} -after {New Group} {testbench}
gui_list_add_group -id ${Wave.1}  -after testbench {testbench|Sgoat}
gui_list_select -id ${Wave.1} {testbench.addr }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group testbench|Sgoat  -item {testbench.addr[15:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 324
