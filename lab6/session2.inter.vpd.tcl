...
# DVE full session
# Saved on Tue Nov 14 15:32:31 2023
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/DCNFS/users/student/kmujtaba/elen127/labs/lab6/session2.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{60 57} {1364 677}}
...
gui_sg_addsignal -group "$_session_group_8" { testbench.dut.Sgoat.we testbench.dut.Sgoat.re testbench.dut.Sgoat.data testbench.dut.Sgoat.Addr testbench.dut.Sgoat.SR1 testbench.addr }
...
gui_wv_zoom_timerange -id ${Wave.1} 119 422
